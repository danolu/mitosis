    ...
    (SEMICOLON.initialize = {
        ...
        (SEMICOLON.header = {
            ...
            fullWidthMenu: function () {
                if (o.hasClass("device-md") || o.hasClass("device-sm") || o.hasClass("device-xs")) return e(".mega-menu-content").css({ width: "" }), !0;
                ...
                if (
                    ...
                    o.hasClass("stretched")
                        ? d.hasClass("floating-header")
                            ? e(".mega-menu:not(.mega-menu-full):not(.mega-menu-small) .mega-menu-content").css({ width: i + 80 })
                            : e(".mega-menu:not(.mega-menu-full):not(.mega-menu-small) .mega-menu-content").css({ width: i })
                ...
                e(document).on("click", function (t) {
                        ...
                        M.hasClass("mobile-menu-off-canvas") &&
                            (e(t.target).closest(".primary-menu.mobile-menu-off-canvas .menu-container").length ||
                                (M.filter(".mobile-menu-off-canvas").find(".menu-container").toggleClass("d-block", !1), o.toggleClass("primary-menu-open", !1))),
        ...
        (SEMICOLON.widget = {
            ...
            parallax: function (e) {
                let i = {
                    element: e,
                    default: ".parallax,.page-title-parallax",
